...
#import "TVOPreflight.h"
#import "TVOPreflightDelegate.h"
#import "TVOPreflightOptions.h"
#import "TVOPreflightReport.h"
...
/**
 * @brief Run a preflight test.
 *
 * @param accessToken The access token.
 * @param delegate A `<TVOPreflightDelegate>` to receive preflight test updates.
 *
 * @return A `<TVOPreflightTest>` object.
 *
 * @see TVOPreflight
 * @see TVOPreflightDelegate
 */
...
NS_SWIFT_NAME(runPreflightTest(accessToken:delegate:));

/**
 * @brief Run a preflight test.
 *
 * @param options The preflight test options.
 * @param delegate A `<TVOPreflightDelegate>` to receive preflight test updates.
 *
 * @return A `<TVOPreflightTest>` object.
 *

...
/**
 * @brief The `<TVOAudioOptions>` that can be applied to underlying media streams or audio processing.
 */
@property (nonatomic, strong, nullable) TVOAudioOptions *audioOptions;

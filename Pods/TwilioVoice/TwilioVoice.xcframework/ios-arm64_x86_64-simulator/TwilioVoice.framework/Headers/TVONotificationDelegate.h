 ...
 *
 * @discussion This method gets invoked synchronously on the same dispatch queue where the `[TwilioVoiceSDK handleNotification:delegate:delegateQueue:callMessageDelegate:]`
 * is called.
 *
 ...
 * This method gets invoked synchronously on the same dispatch queue where the `[TwilioVoiceSDK handleNotification:delegate:delegateQueue:callMessageDelegate:]`
 * is called.
 *

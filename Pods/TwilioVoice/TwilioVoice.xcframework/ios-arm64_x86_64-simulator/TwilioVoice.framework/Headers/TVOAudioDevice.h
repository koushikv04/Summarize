...
__attribute__( (deprecated("Will not be supported in TwilioVoice v7.0+", "TVOAudioDeviceReinitialize")) );
 ...
 * `startRendering:` here.
 */
void TVOAudioDeviceReinitialize(TVOAudioDeviceContext _Nonnull context)
 ...
 *  rendering audio then you should call `TVOAudioDeviceReinitialize()` and prepare for this method to be queried again.
 */
 ...
 *  TVOAudioDeviceReinitialize(), TVOAudioDeviceReadRenderData() and TVOAudioDeviceExecuteWorkerBlock().
 *
 ...
 *  capturing audio then you should call `TVOAudioDeviceReinitialize()` and prepare for this method to be queried again.
 */
 ...
 *  TVOAudioDeviceReinitialize(), TVOAudioDeviceWriteCaptureData() and TVOAudioDeviceExecuteWorkerBlock().
 *

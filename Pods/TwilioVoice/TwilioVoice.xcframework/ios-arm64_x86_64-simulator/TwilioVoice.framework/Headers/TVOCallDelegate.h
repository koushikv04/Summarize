 ...
 * - `TVOCallQualityWarningConstantAudioOutputLevel` - Raised when the standard deviation of audio output levels for last 10 samples is less than or equals 1% of the maximum possible audio output level (32767) i.e. 327.67 and the local call is not placed on `Hold`. Cleared when the standard deviation of audio output levels for last 10 samples is greater than 3% of the maximum possible audio output level.
 *

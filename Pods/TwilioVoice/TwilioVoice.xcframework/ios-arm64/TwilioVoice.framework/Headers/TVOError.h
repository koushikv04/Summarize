...
typedef NS_ERROR_ENUM(kTVOErrorDomain, TVOError) {
    ...
    TVOErrorInvalidPhoneNumberError                       = 13224,    ///< Invalid Phone Number
    ...
    TVOErrorCallMessageTypeInvalidError                   = 31210,    ///< Call message type is invalid.
    TVOErrorCallMessageCallInUnexpectedStateError         = 31211,    ///< Call is in unexpected state.
    TVOErrorCallMessageEventPayloadSizeExceededError      = 31212,    ///< Call message event payload size exceeded authorized limit.

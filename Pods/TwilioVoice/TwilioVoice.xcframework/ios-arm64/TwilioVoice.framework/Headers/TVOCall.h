...
typedef NS_ENUM(NSUInteger, TVOCallQualityWarning) {
    ...
    TVOCallQualityWarningConstantAudioInputLevel, ///< Constant audio input level warning.
    TVOCallQualityWarningConstantAudioOutputLevel ///< Constant audio output level warning.
}
...
/**
   ...
   **Insights**
   ...
   <tr>
   <td>audio-level-warning-raised</td><td>constant-audio-output-level</td><td>The standard deviation of audio output levels for last 10 samples is less than or equals 1% of the maximum possible audio output level (32767) i.e. 327.67 and the local call is not placed on hold</td><td>6.11.0</td>
   </tr>
   <tr>
   <td>audio-level-warning-cleared</td><td>constant-audio-output-level</td><td>constant-audio-output-level warning cleared if the standard deviation of audio output levels for last 10 samples is greater than 3% of the maximum possible audio output level.</td><td>6.11.0</td>
   </tr>
   </table>
